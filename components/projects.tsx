  ...
  return (
    <motion.div ref={ref} style={{
      ...
      <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
        <div className="flex justify-center items-center gap-10 "><h3 className=" text-2xl  dark: text-stone-950">{title}</h3><a  className="text-3xl focus:scale-110 hover:scale-110 active:scale-105 dark:text-black"target="_blank" href={gitUrl}><BsGithub/></a></div>
